...
const ChessGameWrapper = (props) => {
    ...
    React.useEffect(() => {
        socket.on("playerJoinedRoom", statusUpdate => {
            console.log("Un nuevo jugador a entrado a la sala! Nombre: " + statusUpdate.userName + ", Game id: " + statusUpdate.gameId + " Socket id: " + statusUpdate.mySocketId)
    ...
    return (
      <React.Fragment>
        {opponentDidJoinTheGame ? (
          <div style={{textAlign:"center",backgroundColor: "#DEB887"}} >
            <h4 >Tu oponenete: {opponentUserName} </h4>
            <div style={{margin:"0px "+ String((window.innerWidth / 2) - 290)+"px"}}>
              <ChessGame
                playAudio={play}
                gameId={gameid}
          ...
          <div style={{backgroundColor: "#FFE4C4"}} >
            ...
            >
              Hola <strong>{props.myUserName}</strong>, Copia y pega esta URL
              Y envialo a un amigo:
            </h1>
            <textarea
            ...
            <h1 style={{ textAlign: "center", marginTop: "100px" }}>
              {" "}
              Esperando que otro oponente entre a tu sala...{" "}
            </h1>
          </div>
        )}
      </React.Fragment>
