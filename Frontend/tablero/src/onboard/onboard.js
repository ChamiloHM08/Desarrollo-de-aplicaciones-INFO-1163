        ...
        return (<React.Fragment>
            {
                ...
                <Redirect to = {"/game/" + this.state.gameId}><button className="btn btn-success" style = {{marginLeft: String((window.innerWidth / 2) - 60) + "px", width: "120px"}}>Iniciar Juego</button></Redirect>

            :
               <div style = {{backgroundColor : "#FAF0E6"}}>
                    <h1 style={{textAlign: "center", marginTop: String((window.innerHeight / 3)) + "px"}}>Tu Nombre:</h1>
